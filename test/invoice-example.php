    ...
    "data" => array(
        ...
        "data" => array(
            0 => array(
                ...
                "partner_id" => 88, // számla befogadó cég azonosítója
                "partner_user_id" => 81, // számla befogadó cég kapcsolattartó azonosítója
                "partner_billing_id" => 135, // számla befogadó cég számlázási címének azonosítója
                "partner_shipping_id" => 135, // számla befogadó cég szállítási címének azonosítója
                "currency_id" => 1, // számla pénznem azonosítója
            ...
            // számla adattartalom egyszerűsített adatokkal
            1 => array(
                "receipt_type_id" => 8, // bizonylat típusa (8 - számla, 13 - előleg számla, 33 - proformaszámla)
...
$invoice_close = $invoice_client->close(array(
    "data" => array(
        "receipt_id" => 0, // bizonylat azonosító ( fenti példát követve $invoice_save->data->id )
    )
));
