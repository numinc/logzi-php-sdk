...
$reserve_client = new Numinc\Logzi\Reserve_model(array(
	"api_key" => "REPLACE_WITH_YOUR_API_KEY"
));

// hardcode végpont
$reserve_save = $reserve_client->save(array(
    "data" => array(
...
print_r($reserve_save);

// hardcode lezárás
$reserve_close = $reserve_client->close(array(
    "data" => array(
        "receipt_id" => 0, // bizonylat azonosító ( fenti példát követve $reserve_save->data->id )
    )
));

print_r($reserve_close);